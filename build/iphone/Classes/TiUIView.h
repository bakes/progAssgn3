...
/**
 Base class for all HomeworkAssignmentTwo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HomeworkAssignmentTwo view hierarchy (such as wrapped iOS UIViews) was touched.
