...
// in simulator we redefine to format for HomeworkAssignmentTwo Developer console
...
{\
	NSString * exceptionName = [@"org.homeworkassignmenttwo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.homeworkassignmenttwo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHomeworkAssignmentTwoNativeItemNone = -1, 
	UIHomeworkAssignmentTwoNativeItemSpinner = -2,
	UIHomeworkAssignmentTwoNativeItemProgressBar = -3,
	
	UIHomeworkAssignmentTwoNativeItemSlider = -4,
	UIHomeworkAssignmentTwoNativeItemSwitch = -5,
	UIHomeworkAssignmentTwoNativeItemMultiButton = -6,
	UIHomeworkAssignmentTwoNativeItemSegmented = -7,
	
	UIHomeworkAssignmentTwoNativeItemTextView = -8,
	UIHomeworkAssignmentTwoNativeItemTextField = -9,
	UIHomeworkAssignmentTwoNativeItemSearchBar = -10,
	
	UIHomeworkAssignmentTwoNativeItemPicker = -11,
	UIHomeworkAssignmentTwoNativeItemDatePicker = -12,
	
	UIHomeworkAssignmentTwoNativeItemInfoLight = -13,
	UIHomeworkAssignmentTwoNativeItemInfoDark = -14,
	
	UIHomeworkAssignmentTwoNativeItemDisclosure = -15,
	
	UIHomeworkAssignmentTwoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HomeworkAssignmentTwo instances of
