 ...
 * to send analytic data that can be viewed on the HomeworkAssignmentTwo Dashboard.
 *
 * For information on getting started with HomeworkAssignmentTwo Platform Services,
