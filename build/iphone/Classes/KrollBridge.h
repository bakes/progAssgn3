...
@interface HomeworkAssignmentTwoObject : KrollCoverageObject {
#else
@interface HomeworkAssignmentTwoObject : KrollObject {
#endif
@private
...
extern NSString * HomeworkAssignmentTwo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HomeworkAssignmentTwoObject *_homeworkassignmenttwo;
    KrollObject* console;
	BOOL shutdown;
