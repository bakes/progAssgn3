...
//Rare exceptions to indicate a bug in the _homeworkassignmenttwo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for HomeworkAssignmentTwo proxies.
 */
