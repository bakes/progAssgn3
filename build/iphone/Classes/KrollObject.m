...
//@interface HomeworkAssignmentTwoObject : NSObject
//@end

@interface HomeworkAssignmentTwoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HomeworkAssignmentTwoObject class]])
		{
			for (NSString *key in [[(HomeworkAssignmentTwoObject*)o modules] allKeys])
			{
