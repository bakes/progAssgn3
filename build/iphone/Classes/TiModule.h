...
/**
 The base class for all HomeworkAssignmentTwo modules
 */
...
/**
 HomeworkAssignmentTwo Platform calls this method on startup.
 */
-(void)startup;

/**
 HomeworkAssignmentTwo Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 HomeworkAssignmentTwo Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 HomeworkAssignmentTwo Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 HomeworkAssignmentTwo Platform calls this method on resume.
 @param sender The sender of the event.
 */
